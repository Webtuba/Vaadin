...
import com.example.application.views.detalhes.DetalhesView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "TesteVaadin", shortName = "TesteVaadin")
...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        ...
        tabs.add(createTab("Lista", ListaView.class));
        tabs.add(createTab("Detalhes", DetalhesView.class));
